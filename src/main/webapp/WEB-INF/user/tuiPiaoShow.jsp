...
<body>
<span style="font-size:25px;display:block;width:100px;margin:auto;margin-top:100px;">退票</span>
			...
			<tbody>
				<c:forEach items="${xls}" var="xl">
					<tr>
						...
						<td>${xl.jg}</td>
						<td>
							<a href="tuipiao?id=${xl.id}"
							onclick="if(confirm('确认退票吗？')==false)return false">退票</a>
							</td>     
					</tr>
			</c:forEach>
		</tbody>
