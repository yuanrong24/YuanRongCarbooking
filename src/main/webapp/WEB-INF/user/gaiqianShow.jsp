...
<body>
<span style="font-size:25px;display:block;width:100px;margin:auto;margin-top:100px;">改签</span>
			...
			<tbody>
				<c:forEach items="${xls}" var="xl">
					<tr>
						...
						<td>${xl.jg}</td>
						<td>
							<a href="gaiqianReShow?id=${xl.id}&qsdsj=${xl.qsdsj}&mddsj=${xl.mddsj}">改签</a>
							</td>     
					</tr>
			</c:forEach>
		</tbody>
